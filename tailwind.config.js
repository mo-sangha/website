...
export default {
	...
	daisyui: {
		themes: [
			{
				luminosity: {
					primary: '#000', // Highlight color: top bar.
					menu: '#111', // Color of various menu backgrounds.

					// These affect the gradient background. We want all-black.
					'base-100': '#000',
					'base-200': '#000',
					'base-300': '#000',

					secondary: 'white', // Clickable links, etc.
					neutral: '#272727', // Button without hover.
					accent: '#454545', // Button with hover.

					info: 'teal',
					success: '#41d888',
					warning: '#ffcc00',
					error: '#ff0000',
					'text-base-content': '#a9dbf9',
